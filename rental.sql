...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2020 at 02:45 AM
...
INSERT INTO `bookings` (`booking_id`, `vehicle_id`, `user_id`, `start_date`, `end_date`) VALUES
(1, 1, 12, '2020-10-25', '2020-10-31'),
(4, 32, 10, '2020-12-10', '2020-12-25'),
(5, 50, 11, '2020-12-26', '2020-12-29'),
(6, 49, 13, '2020-12-21', '2020-12-28');
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `username`, `password`, `role`, `email`) VALUES
(1, 'Super', 'Admin', 'phpuser', 'phpuser', 1, 'NULL'),
(2, 'Jane', 'Doe', 'jdoe', 'password', 2, 'jane.doe@gmail.com'),
(9, 'admin', 'password', 'admin', '$2y$10$TIIjMXEHX529onm/ueMK8uRdpahhVbJXul6NSIDMe6tAl7cczztCO', 1, 'test@mail.com'),
(10, 'Joe', 'Schmoe', 'jschmoe', '$2y$10$NEDgo6CeWoxZ/JbRTr92uexz./WIYPcLW3p8aZMqTabaVkUPSJ7a6', 2, 'email@email.com'),
(11, 'Hannah', 'Banana', 'hbanana', '$2y$10$6wUjZTUOozVrSKs3pdPqmecYsv0NnZX75K1O8/Qq7D5rLePRXo.2y', 2, 'email@email.com'),
(12, 'Rigby', 'Mordecai', 'rigbone', '$2y$10$klXmy.GmK/6XAkcIsz/Qh.G4ifOsh3UUMIFvlRlxMQ7oId4LGg7Vu', 2, 'mordecai@rigby.com'),
(13, 'Belson', 'Noles', 'belson1', '$2y$10$6XDz.7BizSczgEuCd/gvKugCzajpTqcllFBXUHXVS8/Pfwg.f75yi', 2, 'belson@clarence.com'),
(14, 'regular', 'Customer', 'regular', '$2y$10$MQzbiThoS6TGr2xZ41p42.bTGI.DC/hSIikrLjwk6D32lI.y.SkCq', 2, 'regular@regular.com');
